...
**Docs:** [Plan Mode](https://cursor.com/docs/agent/planning#plan-mode)

## Setup

Enable Plan Mode in the agent settings (click Agent dropdown, select "Plan")
...
2. Enable Plan Mode from the Agent dropdown
3. Watch the agent generate a plan with todos
4. **Optional:** Click "Save to workspace" to save the plan file
5. Click "Build" to execute the plan
